...
class RooCodeAdapter(BaseAgentAdapter):
    @property
    def slug(self) -> str:
        return "roo-code"
    ...
    def config_filename(self) -> str:
        return "roo_persisted_state.json"

    def get_config_path(self) -> str:
        appdata = os.getenv("APPDATA")
        if appdata:
            return os.path.join(appdata, "Code", "User", "globalStorage", "roodev.rogue-dev", "settings", "roo_persisted_state.json")
        return os.path.expanduser("~/.roo_persisted_state.json")
